...
for (const [script, why] of [
  ...
  ['scripts/ci-no-placeholder-synctopic.sh', 'G3 — sync topic reverted to a placeholder carrier (Ledger::Read) instead of the canonical Resource::Sync / Action::Pull; topic taxonomy split again'],
