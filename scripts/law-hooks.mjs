...
// ---------------------------------------------------------------------------
console.log('◆ [sovereign] no-courier-scoring · G1 wire-codec · G2 single-eventlog · G4 scope-subset · G5 red-line-gate · crdt-fence · kernel-fence (structural invariants)');
