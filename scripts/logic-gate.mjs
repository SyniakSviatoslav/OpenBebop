...
// --- 3. Patterns -------------------------------------------------------------
const CLAIM_RE = /(verified|proven|proves?|satisfies|guarantees|ensures|post-quantum claim|byte-exact|RED[→\-]>GREEN|kills?|eliminat|is (true|correct|secure|safe|canonical)|no (serde|openssl)|claimed|asserts|sound|fact)/i;
